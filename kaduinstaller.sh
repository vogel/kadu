...
############################################################################
#!/bin/bash
# $Id: kaduinstaller.sh,v 1.3 2004/04/08 17:57:29 romek Exp $
...
wybierzmoduly()
{
	...
	dialog --separate-output --checklist "Wybierz modu³y do zainstalowania" 0 75 0 \
		...
		autoaway "Obs³uga automatycznej zmiany statusu" on \
    		autoresponder "Przyk³adowy modu³ Autoresponder" 0 2>log_selectedmodule

	rm -fr .config
	
	MODULY="encryption speech sound ext_sound dsp_sound arts_sound esd_sound nas_sound echo autoresponder sms default_sms autoaway"
