...
#ifndef CHAT_NAMED_FILTER_H
#define CHAT_NAMED_FILTER_H

#include "chat/filter/chat-filter.h"
#include "exports.h"

class KADUAPI ChatNamedFilter : public ChatFilter
{
	Q_OBJECT
...
public:
	ChatNamedFilter(QObject *parent = 0);
