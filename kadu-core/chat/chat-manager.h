 ...
 * are defined in core: @link ChatDetailsContact @endlink and @link ChatDetailsConference @endlink
 */
 ...
 * All new chats of standard types (contact and conference) should be created by @link findChat @endlink
