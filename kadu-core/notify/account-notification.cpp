...
AccountNotification::AccountNotification(Account *account, const QString &type, const QIcon &icon, Chat *chat) :
		Notification(type, icon, chat), CurrentAccount(account)
{
