 ...
 *
 * This class describes entry in local and remote roster and its synchronization state. It also has two flags. When
 * Detached flag is true,
 * no synchronization of data is made between local and remote roster. However, deleting detached entries is reflected
 * both locally
 * and remotely.
 */
...
private:
     ...
     *
     * Emits signals from hasLocalChangesNotifier() if new state if RosterEntryState::HasLocalChanges and previous was
     * different.
     */
