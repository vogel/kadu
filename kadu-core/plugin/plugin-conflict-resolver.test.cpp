...
std::unique_ptr<PluginConflictResolver>
PluginConflictResolverTest::createPluginConflictResolver(const QVector<PluginTuple> &plugins)
{
...
PluginConflictResolverTest::createPluginDependencyHandler(const QVector<PluginTuple> &plugins, QObject *parent)
{
...
PluginConflictResolverTest::createMetatadataProvider(const QVector<PluginTuple> &plugins, QObject *parent)
{
...
{
    auto resolver = createPluginConflictResolver(
...
{
    auto resolver = createPluginConflictResolver(
        QVector<PluginTuple>{std::make_tuple(QString{"p1"}, QString{"feature13"}, QStringList{}),
...
{
    auto resolver = createPluginConflictResolver(
        QVector<PluginTuple>{std::make_tuple(QString{"p0"}, QString{}, QStringList{"p1"}),
