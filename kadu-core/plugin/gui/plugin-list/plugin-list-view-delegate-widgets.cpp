...
QList<QWidget *> PluginListWidgetDelegateWidgets::findWidgets(
    const QPersistentModelIndex &idx, const QStyleOptionViewItem &option, UpdateWidgetsEnum updateWidgets)
{
...
PluginListWidgetDelegateEventListener::PluginListWidgetDelegateEventListener(
    PluginListWidgetDelegateWidgets *pool, QObject *parent)
        : QObject(parent), Pool(pool)
{
}
