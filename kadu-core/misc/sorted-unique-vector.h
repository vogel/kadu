 ...
 */
template<typename T, bool (*LessThanComparator)(const T &, const T &), bool (*EqualityComparator)(const T &, const T &)>
inline typename sorted_unique_vector<T, LessThanComparator, EqualityComparator>::Storage::const_iterator begin(const sorted_unique_vector<T, LessThanComparator, EqualityComparator> &sortedVector)
{
 ...
 */
template<typename T, bool (*LessThanComparator)(const T &, const T &), bool (*EqualityComparator)(const T &, const T &)>
inline typename sorted_unique_vector<T, LessThanComparator, EqualityComparator>::Storage::const_iterator end(const sorted_unique_vector<T, LessThanComparator, EqualityComparator> &sortedVector)
{
