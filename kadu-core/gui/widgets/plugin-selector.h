...
public:
    ...
    /**
      ...
      *                         add to the list
      * @param pluginLoadMethod If PluginSelector will try to load the
      ...
      *                         don't want PluginSelector to override them
      *                         when loading
      * @param categoryName     The translated name of the category. This is the
      *                         name that is shown in the title. If the category
      *                         did exist before because of another call to
    ...
    /**
      ...
      * are ticked or not on the PluginSelector dialog, without saving anything
      * anywhere
      */
