...
class KADUAPI ContactOptionsConfigurationWidget : public ConfigurationWidget
{
	Q_OBJECT
...
public:
	ContactOptionsConfigurationWidget(ConfigurationWindowDataManager *dataManager, QWidget *parent = 0);
