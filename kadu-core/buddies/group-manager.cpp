...
bool GroupManager::acceptableGroupName(const QString &groupName)
{
	...
	{
		MessageDialog::msg(tr("'%1' is prohibited").arg(','), true, "dialog-warning.png");
		kdebugf2();
		return false;
	}
	...
	if (number)
	{
		MessageDialog::msg(tr("Numbers are prohibited"), true, "dialog-warning.png");//because of gadu-gadu contact list format...
		kdebugf2();
		return false;
	}
	...
	// TODO All translation
 	...
 	{
		MessageDialog::msg(tr("This group already exists!"), true, "dialog-warning.png");
 		kdebugf2();
 		return false;
 	}
