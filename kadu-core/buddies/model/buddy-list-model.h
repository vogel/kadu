...
public:
     ...
     *
     * This method returns data for given index and role. For buddy indexes data is extraced with @link
     ...
     * If type is @link Talkable @endlink then value is converted to @link Buddy @endlink or @link Contact @endlink
     * first.
