...
protected:
    explicit ChatImageService(Account account, QObject *parent = nullptr);
...
signals:
     ...
     *
     * After receiving this signal requestChatImage() may be called to request image data from a peer. If image data is
     * not
