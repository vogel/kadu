...
public:
     ...
     */
    explicit WebkitMessagesViewHandler(
     ...
     * @todo Think of a way to combine it with setMessageLimitPolicy - currently impossible due to
     * setForcePruneDisabled.
     *
     ...
     */
    const SortedMessages &messages() const
    {
        return m_messages;
    }
