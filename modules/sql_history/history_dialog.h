...
{
	HistorySearchResult();
	UserListElements users;  /*!< Lista u¿ytkowników, których historiê przeszukano. */
...
{
	private:
		UserListElements Uids; /*!< Lista u¿ytkowników reprezentowanych przez dan± pozycjê na li¶cie */
		/**
...
class DetailsListViewItem : public QTreeWidgetItem
{
	private:
		...
		UserListElements Uids;  /*!< Lista u¿ytkowników, do których nale¿y dana data - czasem siê przyda, gdy nie mo¿na zachowaæ zaznaczenia na g³ównej li¶cie. */
	public:
		/**
		...
		*/
		DetailsListViewItem(QTreeWidget* parent, QString contact, QString title, QDate date, QString lenght, const UserListElements& uids = UserListElements());
		/**
...
class HistoryDlg : public QWidget
{
	...
	private:
		...
		HistorySearchParameters searchParameters; /*!< Parametry ostatniego wyszukiwania. */
 		//QList<UserListElements> uid_groups; /*!< Lista grup u¿ytkowników, których rozmowy zapisano w historii. */
 		//QList<UserListElements> status_uid_groups; /*!< Lista grup u¿ytkowników, których zmiany statusów zapisano w historii. */
		...
		HistoryAdvSearchWindow *advSearchWindow; /*!< Okno wyszukiwania. */
...
// 		QList<int>::Iterator idxIt; 
		...
		*/
		...
		UserListElements selectedUsers; /*!< U¿ytkownicy, dla których wyst±pi³o ¿±danie otwarcia okna historii. */
	...
	private slots:
		...
		*/
		...
		void selectedUsersNeeded(UserGroup*&);
		/**
	...
	public:
		...
		*/
		void showDialog(UserListElements users);
...
extern HistoryDlg* historyDialog;
