...
DccManager::DccManager(QObject *parent, const char *name) : QObject(parent, name)
{
	...
	ConfigDialog::addCheckBox("Network", "dcc", QT_TRANSLATE_NOOP("@default", "DCC IP autodetection"), "DccIpDetect", true, QString::null, QString::null, Advanced);

	ConfigDialog::addVGroupBox("Network", "dcc", QT_TRANSLATE_NOOP("@default", "DCC IP"), QString::null, Advanced);
	ConfigDialog::addLineEdit("Network", "DCC IP", QT_TRANSLATE_NOOP("@default", "IP address:"), "DccIP");
	ConfigDialog::addCheckBox("Network", "dcc", QT_TRANSLATE_NOOP("@default", "DCC forwarding enabled"), "DccForwarding", false, QString::null, QString::null, Advanced);

	ConfigDialog::addVGroupBox("Network", "dcc", QT_TRANSLATE_NOOP("@default", "DCC forwarding properties"), QString::null, Advanced);
