...
void CenzorConfigurationUiHandler::registerConfigurationUi()
{
	if (!Instance)
	{
		...
		MainConfigurationWindow::registerUiFile(dataPath("kadu/modules/configuration/cenzor.ui"));
...
void CenzorConfigurationUiHandler::unregisterConfigurationUi()
{
	if (Instance)
	{
		...
		MainConfigurationWindow::unregisterUiFile(dataPath("kadu/modules/configuration/cenzor.ui"));
		delete Instance;
		Instance = 0;
	}
}
