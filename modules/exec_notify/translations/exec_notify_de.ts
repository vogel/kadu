...
<context>
    <name>@default</name>
    <message>
        <location filename="../exec_notify.cpp" line="93"/>
        <source>Exec</source>
...
<context>
 ...
 %o - return _space_ if user doesn&apos;t have us in userlist  %v - revDNS, %p - port %e - email %x - max image size</source>
        <translation type="obsolete">Syntay: #{action} - Aktion, #{protocol} - Protokol, %ids - UIN&apos;s, %s - Status, %d - Beschreibung, %i - IP, %n - Nick-Name,
%a - Alternativer-Nick, %f - Vorname %r - Nachname,  %m - Handy, %u - UIN, %g - Gruppe
%o -  Leerzeichen, wenn Sie nicht in der Kontaktliste sind %v - revDNS, %p - Port %e - Email %x - maximale Bildgröße</translation>
    </message>
    <message>
        <location filename="../exec_notify.cpp" line="47"/>
