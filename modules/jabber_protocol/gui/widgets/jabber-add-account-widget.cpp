...
JabberAddAccountWidget::JabberAddAccountWidget(QWidget *parent) :
		AccountAddWidget(parent), ShowConnectionOptions(false)
{
...
void JabberAddAccountWidget::createIHaveAccountGui(QGridLayout *gridLayout, int &row)
{
...
void JabberAddAccountWidget::createRegisterAccountGui(QGridLayout *gridLayout, int &row)
{
	// Initialize settings
	ssl_ = 0;
...
bool JabberAddAccountWidget::checkSSL()
{
...
void JabberAddAccountWidget::hostToggled(bool on)
{
...
void JabberAddAccountWidget::sslActivated(int i)
{
...
void JabberAddAccountWidget::connectionOptionsChanged()
{
...
void JabberAddAccountWidget::haveJidChanged(bool haveJid)
{
...
void JabberAddAccountWidget::iHaveAccountDataChanged()
{
...
void JabberAddAccountWidget::registerAccountDataChanged()
{
...
void JabberAddAccountWidget::registerNewAccount()
{
...
void JabberAddAccountWidget::registerNewAccountFinished(JabberServerRegisterAccount *jsra)
{
	if (jsra->result())
	{
