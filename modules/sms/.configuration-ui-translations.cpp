			...
			QT_TRANSLATE_NOOP("@default", "SMS Nick");
		
			

			
			QT_TRANSLATE_NOOP("@default", "Application");
			...
			QT_TRANSLATE_NOOP("@default", "Use SMS custom string");
			...
			QT_TRANSLATE_NOOP("@default", "Gateways");
