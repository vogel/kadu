...
private:
	...
	int notifyTypeFromContact(Buddy &contact);
	void sendUserList();
...
private slots:
	...
	void contactAccountDataIdChanged(Buddy &contact, Account contactAccount, const QString &oldId);
...
public:
	...
	UinType uin(Buddy contact) const;
	GaduContactAccountData * gaduContactAccountData(Buddy contact) const;
