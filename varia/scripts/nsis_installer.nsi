...
LangString NAME_SectionExternalPlugins ${LANG_POLISH} "Zewnêtrzne wtyczki"
...
LangString DESC_SectionExternalPlugins ${LANG_POLISH} "Dodatkowe wtyczki dostarczone przez zewnêtrznych twórców. Zawieraj¹ anonymous_check, import_history, lednotify, mime_tex, networkping, nextinfo oraz senthistory."
LangString NAME_SectionDesktopShortCut ${LANG_ENGLISH} "Desktop Shortcut"
LangString NAME_SectionDesktopShortCut ${LANG_POLISH} "Skrót na pulpicie"
