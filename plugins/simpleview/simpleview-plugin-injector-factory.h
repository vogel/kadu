...
class SimpleviewPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit SimpleviewPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~SimpleviewPluginInjectorFactory();
