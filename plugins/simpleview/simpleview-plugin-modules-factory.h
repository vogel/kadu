...
class SimpleviewPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit SimpleviewPluginModulesFactory(QObject *parent = nullptr);
	virtual ~SimpleviewPluginModulesFactory();
