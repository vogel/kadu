...
WinampMediaPlayer::WinampMediaPlayer(QObject *parent) : QObject{parent}
{
}
...
QString WinampMediaPlayer::getFileTagW(int position, QString tag)
{
    ...
    if (hWinamp)
    {
        ...
        extendedFileInfoStructW *pFileInfo = (extendedFileInfoStructW *)VirtualAllocEx(
            hWinampProcess, NULL, sizeof(extendedFileInfoStructW), MEM_COMMIT, PAGE_READWRITE);
...
QString WinampMediaPlayer::getFileTagA(int position, QString tag)
{
    ...
    if (hWinamp)
    {
        ...
        extendedFileInfoStruct *pFileInfo = (extendedFileInfoStruct *)VirtualAllocEx(
            hWinampProcess, NULL, sizeof(extendedFileInfoStruct), MEM_COMMIT, PAGE_READWRITE);
