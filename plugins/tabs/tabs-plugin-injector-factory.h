...
class TabsPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit TabsPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~TabsPluginInjectorFactory();
