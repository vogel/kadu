...
class SpeechPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit SpeechPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~SpeechPluginInjectorFactory();
