...
class SpeechPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit SpeechPluginModulesFactory(QObject *parent = nullptr);
	virtual ~SpeechPluginModulesFactory();
