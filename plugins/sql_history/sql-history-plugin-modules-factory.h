...
class SqlHistoryPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit SqlHistoryPluginModulesFactory(QObject *parent = nullptr);
	virtual ~SqlHistoryPluginModulesFactory();
