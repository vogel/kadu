...
class ExtSoundPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit ExtSoundPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~ExtSoundPluginInjectorFactory();
