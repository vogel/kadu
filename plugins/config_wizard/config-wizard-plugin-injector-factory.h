...
class ConfigWizardPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit ConfigWizardPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~ConfigWizardPluginInjectorFactory();
