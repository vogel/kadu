...
CropImageWidget::CropImageWidget(QWidget *parent) : QGraphicsView(parent), IsMouseButtonPressed(false)
{
    ...
    connect(
        BottomLeftHandler, SIGNAL(movedTo(HandlerType, int, int)), this, SLOT(handlerMovedTo(HandlerType, int, int)));
    ...
    connect(
        BottomRightHandler, SIGNAL(movedTo(HandlerType, int, int)), this, SLOT(handlerMovedTo(HandlerType, int, int)));
