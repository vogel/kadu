...
class ScreenshotPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit ScreenshotPluginModulesFactory(QObject *parent = nullptr);
	virtual ~ScreenshotPluginModulesFactory();
