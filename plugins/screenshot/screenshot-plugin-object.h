...
private slots:
	...
	INJEQT_SETTER void setScreenshotActions(ScreenshotActions *screenshotActions);
	INJEQT_SETTER void setScreenShotConfigurationUiHandler(ScreenShotConfigurationUiHandler *screenShotConfigurationUiHandler);
