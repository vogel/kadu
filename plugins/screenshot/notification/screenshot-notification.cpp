...
void ScreenshotNotification::notifySizeLimit(InjectedFactory *injectedFactory, NotificationManager *notificationManager, long size)
{
	ScreenshotNotification *notification = injectedFactory->makeInjected<ScreenshotNotification>();
