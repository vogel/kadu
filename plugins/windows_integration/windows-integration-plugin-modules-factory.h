...
class WindowsIntegrationPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit WindowsIntegrationPluginModulesFactory(QObject *parent = nullptr);
	virtual ~WindowsIntegrationPluginModulesFactory();
