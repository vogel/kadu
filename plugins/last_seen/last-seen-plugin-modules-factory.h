...
class LastSeenPluginModulesFactory : public PluginModulesFactory
{
    Q_OBJECT
...
public:
    explicit LastSeenPluginModulesFactory(QObject *parent = nullptr);
    virtual ~LastSeenPluginModulesFactory();
