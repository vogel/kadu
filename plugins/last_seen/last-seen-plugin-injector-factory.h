...
class LastSeenPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit LastSeenPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~LastSeenPluginInjectorFactory();
