...
class ChatNotifyPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit ChatNotifyPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~ChatNotifyPluginInjectorFactory();
