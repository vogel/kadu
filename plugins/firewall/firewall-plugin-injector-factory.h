...
class FirewallPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit FirewallPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~FirewallPluginInjectorFactory();
