...
class AutoHidePluginInjectortFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit AutoHidePluginInjectortFactory(QObject *parent = nullptr);
	virtual ~AutoHidePluginInjectortFactory();
