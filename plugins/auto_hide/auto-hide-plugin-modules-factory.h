...
class AutoHidePluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit AutoHidePluginModulesFactory(QObject *parent = nullptr);
	virtual ~AutoHidePluginModulesFactory();
