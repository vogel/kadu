...
class FreedesktopNotifyPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit FreedesktopNotifyPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~FreedesktopNotifyPluginInjectorFactory();
