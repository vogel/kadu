...
void FreedesktopNotifier::setNotificationCallbackRepository(
...
void FreedesktopNotifier::init()
{
    ...
    NotificationsInterface = new QDBusInterface(
    ...
    NotificationsInterface->connection().connect(
...
void FreedesktopNotifier::checkServerCapabilities()
{
    ...
    if (replyMsg.type() != QDBusMessage::ReplyMessage)
        ...
        KdePlasmaNotifications = replyMsg.arguments().at(0).toString().contains("Plasma") &&
                                 replyMsg.arguments().at(1).toString().contains("KDE");
...
void FreedesktopNotifier::slotServiceOwnerChanged(
