...
class ExecNotifyPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit ExecNotifyPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~ExecNotifyPluginInjectorFactory();
