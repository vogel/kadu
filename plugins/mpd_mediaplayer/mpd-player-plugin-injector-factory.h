...
class MpdPlayerPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit MpdPlayerPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~MpdPlayerPluginInjectorFactory();
