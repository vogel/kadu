...
class MprisPlayerPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit MprisPlayerPluginModulesFactory(QObject *parent = nullptr);
	virtual ~MprisPlayerPluginModulesFactory();
