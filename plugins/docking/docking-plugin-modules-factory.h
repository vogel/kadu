...
class DockingPluginModulesFactory : public PluginModulesFactory
{
    Q_OBJECT
...
public:
    explicit DockingPluginModulesFactory(QObject *parent = nullptr);
    virtual ~DockingPluginModulesFactory();
