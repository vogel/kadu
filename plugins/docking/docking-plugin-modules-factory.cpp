...
DockingPluginModulesFactory::DockingPluginModulesFactory(QObject *parent) : PluginModulesFactory{parent}
{
}

DockingPluginModulesFactory::~DockingPluginModulesFactory()
{
}
