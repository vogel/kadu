...
class IndicatorDockingPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit IndicatorDockingPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~IndicatorDockingPluginInjectorFactory();
