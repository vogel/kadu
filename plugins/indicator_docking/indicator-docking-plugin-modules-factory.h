...
class IndicatorDockingPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit IndicatorDockingPluginModulesFactory(QObject *parent = nullptr);
	virtual ~IndicatorDockingPluginModulesFactory();
