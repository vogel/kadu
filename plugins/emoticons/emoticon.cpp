...
Emoticon::Emoticon(const QString &text, const QString &staticFilePath, const QString &animatedFilePath) :
		Text(text), StaticFilePath(staticFilePath), AnimatedFilePath(animatedFilePath)
{
}
