...
class FiledescPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit FiledescPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~FiledescPluginInjectorFactory();
