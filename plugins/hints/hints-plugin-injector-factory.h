...
class HintsPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit HintsPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~HintsPluginInjectorFactory();
