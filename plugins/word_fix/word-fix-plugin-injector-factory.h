...
class WordFixPluginInjectortFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit WordFixPluginInjectortFactory(QObject *parent = nullptr);
	virtual ~WordFixPluginInjectortFactory();
