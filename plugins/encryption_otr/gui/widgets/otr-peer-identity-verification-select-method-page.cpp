...
void OtrPeerIdentityVerificationSelectMethodPage::createGui()
{
    ...
    layout->addWidget(
        createDescirptionLabel(
            tr("Ask peer a question that only you and he/she know the answer for. If your peer "
    ...
    layout->addWidget(
        createDescirptionLabel(
            tr("Exchange a secret message with peer. This message should be agreed to on another "
    ...
    layout->addWidget(
        createDescirptionLabel(
            tr("Check your peer's fingerprint manually. Fingreprint information shoud be exchanged "
