...
void OtrPeerIdentityVerificationWindowRepository::setPeerIdentityVerificationWindowFactory(
...
void OtrPeerIdentityVerificationWindowRepository::showRespondQuestionAndAnswerVerificationWindow(
    const Contact &contact, const QString &question)
{
