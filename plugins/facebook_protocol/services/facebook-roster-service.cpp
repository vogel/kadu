...
FacebookRosterService::FacebookRosterService(QVector<Contact> contacts, Protocol &protocol, QFacebookSession &facebookSession) :
		RosterService{std::move(contacts), &protocol},
		m_facebookSession{facebookSession}
{
	connect(&facebookSession, &QFacebookSession::contactsReceived,
			this, &FacebookRosterService::contactsReceived);
	connect(&facebookSession, &QFacebookSession::contactsDeltaReceived,
			this, &FacebookRosterService::contactsDeltaReceived);
	downloadRoster();
}
...
void FacebookRosterService::contactsDeltaReceived(const QFacebookDownloadContactsDeltaResult &downloadContactsDeltaResult)
{
