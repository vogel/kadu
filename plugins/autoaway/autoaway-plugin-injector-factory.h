...
class AutoawayPluginInjectortFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit AutoawayPluginInjectortFactory(QObject *parent = nullptr);
	virtual ~AutoawayPluginInjectortFactory();
