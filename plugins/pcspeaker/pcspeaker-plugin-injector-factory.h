...
class PCSpeakerPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit PCSpeakerPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~PCSpeakerPluginInjectorFactory();
