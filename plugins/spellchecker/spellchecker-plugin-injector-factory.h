...
class SpellcheckerPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit SpellcheckerPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~SpellcheckerPluginInjectorFactory();
