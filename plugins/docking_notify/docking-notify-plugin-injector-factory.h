...
class DockingNotifyPluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit DockingNotifyPluginInjectorFactory(QObject *parent = nullptr);
	virtual ~DockingNotifyPluginInjectorFactory();
