...
DockingNotifier::DockingNotifier(QObject *parent)
        : QObject{parent}, Notifier(
                               "Tray Icon Balloon", QT_TRANSLATE_NOOP("@default", "Tray Icon Balloon"),
                               KaduIcon("external_modules/qt4notify"))
{
}
...
QString
DockingNotifier::parseText(const QString &text, const Notification &notification, const NormalizedHtmlString &def)
{
    QString ret;
...
void DockingNotifier::notify(const Notification &notification)
{
    ...
    unsigned int icon =
        m_configuration->deprecatedApi()->readNumEntry("Qt4DockingNotifier", QString("Event_") + key + "_icon");
    QString title =
        m_configuration->deprecatedApi()->readEntry("Qt4DockingNotifier", QString("Event_") + key + "_title");
    QString syntax =
        m_configuration->deprecatedApi()->readEntry("Qt4DockingNotifier", QString("Event_") + key + "_syntax");

    m_docking->showMessage(
        parseText(title, notification, notification.text), parseText(syntax, notification, notification.details),
...
void DockingNotifier::createDefaultConfiguration()
{
    ...
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToFreeForChat_timeout", 10);
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToFreeForChat_syntax", "%&d");
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToFreeForChat_title", "%&m");
    ...
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToNotAvailable_timeout", 10);
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToNotAvailable_syntax", "%&d");
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToNotAvailable_title", "%&m");
    m_configuration->deprecatedApi()->addVariable("Qt4DockingNotifier", "Event_StatusChanged/ToNotAvailable_icon", 0);

    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToDoNotDisturb_timeout", 10);
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToDoNotDisturb_syntax", "%&d");
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_StatusChanged/ToDoNotDisturb_title", "%&m");
    ...
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Event_FileTransfer/IncomingFile_syntax", "%&m");
    ...
    m_configuration->deprecatedApi()->addVariable(
        "Qt4DockingNotifier", "Qt4DockingNotificationEventConfiguration_Geometry", "50, 50, 615, 290");
}
