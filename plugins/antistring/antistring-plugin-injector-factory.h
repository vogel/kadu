...
class AntistringPluginInjectortFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit AntistringPluginInjectortFactory(QObject *parent = nullptr);
	virtual ~AntistringPluginInjectortFactory();
