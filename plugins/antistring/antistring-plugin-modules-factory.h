...
class AntistringPluginModulesFactory : public PluginModulesFactory
{
	Q_OBJECT
...
public:
	explicit AntistringPluginModulesFactory(QObject *parent = nullptr);
	virtual ~AntistringPluginModulesFactory();
