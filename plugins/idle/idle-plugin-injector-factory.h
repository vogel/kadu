...
class IdlePluginInjectorFactory : public PluginInjectorFactory
{
	Q_OBJECT
...
public:
	explicit IdlePluginInjectorFactory(QObject *parent = nullptr);
	virtual ~IdlePluginInjectorFactory();
