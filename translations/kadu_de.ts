...
%h - gg version, %v - revDNS, %p - port %e - email %x - max image size
        ...
        <translation>Syntay: %s - Status, %d - Beschreibung, %i - IP, %n - Nick, %a - Alternativ-Nick, %f - Vorname
%r - Nachname, %m - Handy, %u - Nummer GG, %g - Gruppe, %o - Leerzeichen, wenn wir nicht in seiner Kontaktliste sind
%h - Version GG, %v - revDNS, %p - Port, %e - Email, %x - Bildgröße</translation>
    </message>
    <message>
